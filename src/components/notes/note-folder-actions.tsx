...
import { deleteFolderAction, renameFolderAction } from "@/actions/notes";
...
export function NoteFolderActions({ folderId, name }: { folderId: string; name: string }) {
      ...
      <AlertDialog open={deleteOpen} onOpenChange={setDeleteOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              As notas desta pasta não são apagadas, apenas ficam sem pasta. Subpastas dentro
