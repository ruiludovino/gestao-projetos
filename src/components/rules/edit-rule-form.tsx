...
import { updateRuleAction, type RuleFormState } from "@/actions/rules";
...
export function EditRuleForm({
  ...
  const action = updateRuleAction.bind(null, ruleId);
      ...
      <div>
        ...
        <div className="mt-4">
          {content ? (
            ...
            <p className="text-sm text-muted-foreground">Regra vazia.</p>
          )}
        </div>
      </div>
    );
